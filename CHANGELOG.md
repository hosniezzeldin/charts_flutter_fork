# 0.13.0
* Added compatibility with the latest version of flutter at the time of publishing 3.24.5
...
charts_flutter_fork library. This is a breaking change if you are using charts_common behavior.
